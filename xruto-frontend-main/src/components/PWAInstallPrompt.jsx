        ...
        <div className="fixed bottom-4 left-4 right-4 bg-gradient-to-r from-blue-600 to-purple-600 text-xr-text rounded-lg shadow-lg p-4 z-50 md:left-auto md:right-4 md:max-w-sm">
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0">
              <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-lg border border-xr-line bg-xr-elevated p-0.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-xr-info mt-1">
              ...
              <div className="flex space-x-2 mt-3">
                ...
                <button
                  ...
                  className="text-xr-info text-xs px-3 py-1 rounded border border-blue-300 hover:bg-blue-500 transition-colors"
                >
                  Not now
                </button>
              </div>
            ...
            <button
              ...
              className="flex-shrink-0 text-xr-info hover:text-xr-text"
            >
