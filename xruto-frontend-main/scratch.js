...
files.forEach(file => {
  ...
  // Need to fix text-white in buttons and badges
  // It's tricky to contextually fix text-white. Let's fix primary buttons manually if needed.
  // Actually, we can revert text-xr-text inside specific components if needed.
